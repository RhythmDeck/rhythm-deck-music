...
// FIXED SIGNUP ROUTE — THIS IS THE ONLY CHANGE
app.post('/signup', async (req, res) => {
  ...
  try {
    ...
    // Save subdomain immediately for Pro users too
    if (subdomain) {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      mode: 'subscription',
      // THIS LINE WAS THE ENTIRE PROBLEM
      success_url: `${req.headers.origin}/profile-admin-pro.html`,  // CLEAN URL — NO UUID!
